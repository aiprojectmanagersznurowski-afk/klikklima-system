...
4. **Rozpoczęcie Monetyzacji Spółki od Marca 2027 r. (Public Go-Live):**
   - W okresie testów bojowych (**Dry Run: grudzień 2026 r. – luty 2027 r.**, z uwzględnieniem możliwości wydłużenia) KlikKlima Sp. z o.o. **nie realizuje zysków z montaży**. Całość marży (100%) z montaży na klientach testowych zatrzymuje **Piotrek (Kort Klima / Cord Klima)**.
   - Spółka KlikKlima realizuje zyski ze sprzedaży **dopiero od Marca 2027 r.** (Public Go-Live), po zaliczeniu bramek jakościowych i uruchomieniu publicznego rynku.
   - W przypadku wyboru Wariantu B (wspólnicy 51/49) po fazie testów, zlecenia i klienci pozyskiwani przez Kort Klima wchodzą do wspólnego rozliczenia spółki, co drastycznie **zmniejsza ryzyko braku przychodów**, gdyby startowe kampanie reklamowe KlikKlima potrzebowały dłuższego czasu na optymalizację algorytmów reklamowych (de-risking płynnościowy).
...
- _Wniosek:_ Przy bazie 500 urządzeń coroczny serwis generuje **65 000 zł czystej marży gotówkowej** bez ponoszenia kosztów płatnego marketingu (CAC = 0 zł, powiadomienia SMS wysyła automat `cron`).
...
flowchart LR
    ...
    P2["<b>XII 2026 – II 2027</b><br/>Dry Run & Onboarding<br/>100% zysków z montaży u Piotra<br/><i>EBITDA KlikKlima: -2.45k/mc</i>"]
    P3["<b>III 2027</b><br/>Public Go-Live<br/>15 montaży/mc (start zysków KlikKlima)<br/><b>EBITDA: +20.8k (Break-Even!)</b>"]
...
> **Zasada Dry Runa (XII 2026 – II 2027):** Zyski ze wszystkich zleceń pilotażowych (testy na klientach Piotra) trafiają w **100% do Piotra (Kort Klima)**. Spółka KlikKlima Sp. z o.o. w tym okresie testuje system IT i procedury, ponosząc jedynie minimalne koszty stałe OPEX (finansowane z kapitału założycielskiego). **Realizacja zysków przez KlikKlima Sp. z o.o. rozpoczyna się w Marcu 2027 r. (Public Go-Live).**

| Miesiąc / Etap                       | Liczba montaży | Przychody ze sprzedaży (brutto) | Koszt sprzętu COGS (brutto) | Koszt ekip (taryfikator) |       Marża Brutto KlikKlima       |   Budżet Marketingowy    |  Koszty Stałe OPEX  | Zysk Operacyjny EBITDA KlikKlima |  Skumulowany Cash Flow KlikKlima  |
| :----------------------------------- | :------------: | :-----------------------------: | :-------------------------: | :----------------------: | :--------------------------------: | :----------------------: | :-----------------: | :------------------------------: | :-------------------------------: |
| **Listopad 2026 (Fundamenty)**       |       0        |              0 zł               |            0 zł             |           0 zł           |                0 zł                |           0 zł           | 12 500 zł _(setup)_ |          **-12 500 zł**          |          **-12 500 zł**           |
| **Grudzień 2026 (Dry Run 1)**        |   4 _(test)_   |            24 800 zł            |          10 800 zł          |         6 000 zł         | **0 zł** _(100% zysku dla Piotra)_ |   0 zł _(baza Piotra)_   |      2 450 zł       |          **-2 450 zł**           |          **-14 950 zł**           |
| **Styczeń 2027 (Dry Run 2)**         |   4 _(test)_   |            24 800 zł            |          10 800 zł          |         6 000 zł         | **0 zł** _(100% zysku dla Piotra)_ |   0 zł _(baza Piotra)_   |      2 450 zł       |          **-2 450 zł**           |          **-17 400 zł**           |
| **Luty 2027 (Onboarding / bufor)**   |   2 _(test)_   |            12 400 zł            |          5 400 zł           |         3 000 zł         | **0 zł** _(100% zysku dla Piotra)_ |    0 zł _(warsztaty)_    |      2 450 zł       |          **-2 450 zł**           |          **-19 850 zł**           |
| **Marzec 2027 (Public Go-Live)**     |     **15**     |          **93 000 zł**          |        **40 500 zł**        |      **22 500 zł**       |   **29 497 zł** _(start zysków)_   | **6 000 zł** _(CAC 400)_ |    **2 650 zł**     |          **+20 847 zł**          |    **+997 zł** _(Break-Even!)_    |
| **Kwiecień 2027 (Start sezonu)**     |     **35**     |           217 000 zł            |          94 500 zł          |        52 500 zł         |             68 828 zł              |        14 000 zł         |      2 850 zł       |          **+51 978 zł**          | **+52 975 zł** _(Próg dywidendy)_ |
| **Maj 2027 (Rozwinięcie)**           |     **55**     |           341 000 zł            |         148 500 zł          |        82 500 zł         |             108 158 zł             |        22 000 zł         |      3 100 zł       |          **+83 058 zł**          |          **+136 033 zł**          |
| **Czerwiec 2027 (Szczyt sezonu)**    |     **75**     |           465 000 zł            |         202 500 zł          |        112 500 zł        |             147 489 zł             |        30 000 zł         |      3 500 zł       |         **+113 989 zł**          |          **+250 022 zł**          |
| **Lipiec 2027 (Szczyt sezonu)**      |     **85**     |           527 000 zł            |         229 500 zł          |        127 500 zł        |             167 154 zł             |        34 000 zł         |      3 800 zł       |         **+129 354 zł**          |          **+379 376 zł**          |
| **Sierpień 2027 (Dojście do Skali)** |     **90**     |           558 000 zł            |         243 000 zł          |        135 000 zł        |             176 986 zł             |        36 000 zł         |      4 000 zł       |         **+136 986 zł**          |          **+516 362 zł**          |
| **Wrzesień 2027 (ULTIMATE GOAL)**    |    **100**     |         **620 000 zł**          |       **270 000 zł**        |      **150 000 zł**      |           **196 652 zł**           |      **40 000 zł**       |    **4 500 zł**     |         **+152 152 zł**          |          **+668 514 zł**          |
...
_Prognoza sporządzona w celach strategicznych i inwestycyjnych przez założycieli KlikKlima Sp. z o.o._

...
export const NOTIFICATIONS: readonly NotificationDef[] = [
  ...
  { id: "N8a", domain: "FUNNEL", channels: ["EMAIL"], recipient: "CLIENT", bind: {"kind":"TRANSITION","transition":"T17"}, vars: ["first_name","order_number","link"], attachments: ["invoice_phase_1"], templateKey: "funnel.install_phase1_completed", status: "STABLE" },

...
export const TRANSITIONS: readonly LeadTransition[] = [
  ...
  { id: "T17", from: "AWAITING_INSTALLATION", to: "AWAITING_INSTALLATION", action: "completePhaseOne", actor: "INSTALLER", trigger: "MANUAL", guards: ["installationIsTwoPhase","phaseOneNotCompleted"], effects: ["N8a","do:openPhaseTwoBooking"], req: ["FNL-2PHASE","FNL-2PHASE-BOOKING"], status: "STABLE", manualEquivalent: true },

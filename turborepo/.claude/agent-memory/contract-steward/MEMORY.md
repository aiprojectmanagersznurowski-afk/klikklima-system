...
- [FLD-QUOTE-BASKET-SELECT zamknięte za drugim podejściem](project_fld_quote_basket_select_refused_dead_helpers.md) — 2026-09-16 DONE; odmowa wymusiła konsumenta; został dług: nikt nie asertuje `value={basket.id}`.

...
<!-- WYGENEROWANE z .claude/commands/kk-loop.md przez tools/kk-port-antigravity.mjs — nie edytuj ręcznie. -->

# Pętla wykonawcza dla: {{args}}

Work Order: @docs/workorders/{{args}}.md

...
<!-- WYGENEROWANE z .claude/commands/kk-plan.md przez tools/kk-port-antigravity.mjs — nie edytuj ręcznie. -->
...
1. Ustal, którego wymagania z rejestru dotyczy `{{args}}`. Jeśli żadnego — zatrzymaj się i powiedz, że wymaganie trzeba najpierw dodać do kontraktu (to zadanie dla człowieka i contract-steward, nie twoje).
